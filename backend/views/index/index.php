...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="admin/images/profile_small.jpg"/></span>
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li>
                                <a href="<?php echo Url::to(\Yii::$app->urlManager->createUrl('login/login-out')); ?>">安全退出</a>
                            </li>
                        </ul>
                    </div>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row content-tabs">
            ...
            <a href="<?php echo Url::to(\Yii::$app->urlManager->createUrl('login/login-out')); ?>" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i>
                退出</a>
        </div>
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%"
                    src="<?php echo Url::to(\Yii::$app->urlManager->createUrl('index/index-page')); ?>" frameborder="0"
